...
import { IDataAPI, IFinancialRiskUpdate } from '../types';
...
export class FinancialRiskUpdateService extends EntityUpdateService<IFinancialRiskUpdate> {
    public parentEntities = [
        ...
        'RiskImpactLevel',
        'RiskProbability',
        'FinancialRisk($expand=Group,Directorate,FinancialRiskMitigationActions,UnmitigatedRiskImpactLevel,UnmitigatedRiskProbability,RiskAppetite,RiskRiskTypes)',
        'RiskRegister'
    ];
    ...
    constructor(spfxContext: WebPartContext, api: IDataAPI) {
        super(spfxContext, api, `/FinancialRiskUpdates`);
    }
