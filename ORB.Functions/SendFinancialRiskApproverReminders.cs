...
{
    public class SendFinancialRiskApproverReminders
    {
        ...
        public SendFinancialRiskApproverReminders(
        ...
        [Function("SendFinancialRiskApproverReminders")]
        public void Run([TimerTrigger("0 30 9 * * *")] dynamic myTimer, FunctionContext context)
        {
            var log = context.GetLogger("SendFinancialRiskApproverReminders");
            ...
            if (weeklyCycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, wr.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
            ...
            if (fortnightlyCycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, fr.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
            ...
            if (monthlyCycleDue != null || monthlyWeekdayCycleDue != null || monthlyWeekday2CycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, mr.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
            ...
            if (quarterlyCycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, qr.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
            ...
            if (biannuallyCycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, br.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
            ...
            if (annuallyCycleDue != null)
            {
                ...
                Notifications.SendEmails(log, _emailService, _emailSettings, ar.Distinct(), _emailSettings.FinancialRiskApproverReminderTemplateId, templateVars);
            }
        }
        ...
        private void AddFinancialRiskRecipients(List<string> recipients, IReportingCycle reportingCycle)
        {
            ...
            risks.ForEach(r => recipients.AddRange(_userService.ApproverUsersInFinancialRisk(r).Select(u => u.Username)));
        }
    }
}
